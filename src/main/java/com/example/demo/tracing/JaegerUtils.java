...
import com.example.demo.test.TracingConfig;
...
public class JaegerUtils {
  ...
  private static OpenTracingOptions getJaegerOpenTracingOptions() {
    try {
      ...
      OpenTelemetry openTelemetry = TracingConfig.initDynatrace();
      System.out.println("getTracer");
      Tracer bridgeTracer = OpenTracingShim.createTracerShim(openTelemetry);
      ...
      return getOpenTracingOptionsForTracer(bridgeTracer);
